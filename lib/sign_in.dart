        ...
        children: [
          ...
          SafeArea(
            child: ListView(children: [
                      ...
                      Expanded(flex: 5,
                        child: Padding(
                          ...
                          child: Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly,children: [
                            ...
                            Container(child: ElevatedButton(onPressed: (){},child: Text('Create account',style: TextStyle(color: Colors.white),),style: ButtonStyle(
                              backgroundColor: MaterialStateProperty.all(Colors.blue)
                            ),),),
                            Container(child: Row(children: [
                              Text('Already have an account?'),
                              TextButton(onPressed: (){}, child: Text('Sign In',style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: Colors.black87),))
                            ],),)
                          ],),
                        ),
                      )
              ...
              Padding(
                padding: const EdgeInsets.all(15.0),
                child: Container(child:ElevatedButton(onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context)=>Selection()));},child: Row(children: [
